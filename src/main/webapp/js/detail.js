...
//        }
    ...
    changePage : function(displayInfoDetail) {
        ...
        const LAST_DUMMY_INDEX = displayInfoDetail.productImages.length + 1;
        const FIRST_DUMMY_INDEX = 0;
        const LAST_DATA_INDEX = displayInfoDetail.productImages.length;
...
const productBookingButton = {
    initButton : function(displayInfoId) {
        ...
        bookingButton.addEventListener("click", function() {
            location.href = "/booking?id=" + displayInfoId;
        });
    }
}
...
let productReviewContainer = {
    ...
    initShowMoreReviewButton(displayInfoDetail) {
        ...
        showMoreReviewButton.addEventListener("click", function() {
            location.href = "/review?id=" + extractPathVariable.getParameter("id");
        })
    }
}
...
const tabContainer = {
    initTabContainer : function(displayInfoDetail) {
        this.loadTabContainerInfo(displayInfoDetail);
    ...
    loadTabContainerInfo : function(displayInfoDetail) {
        		...
        		mapImage.src = "/" + displayInfoDetail.displayInfoImage.saveFileName;
    }
}