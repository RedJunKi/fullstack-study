    ...
    <div id="container">
        ...
        <div class="header fade">
            <header class="header_tit">
                ...
                <a href="/booking-login" class="btn_my"> <span title="예약확인">예약확인</span> </a>
            </header>
        </div>
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    <a href="javascript:window.history.back()" id="go-back-btn" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        ...
                        <p id="product-opening-hours" class="dsc">
        ...
        <div class="qty" data-productPriceId={{this.productPriceId}}>
            <div class="count_control">
                <div class="clearfix">
                    ...
                    <a class="btn_plus_minus spr_book2 ico_plus3 plus_button" title="더하기"> </a>
                </div>
