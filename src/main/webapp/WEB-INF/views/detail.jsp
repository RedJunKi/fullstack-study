            ...
            <div>
                <div class="section_visual">
                    ...
                    <div class="pagination">
                        ...
                        <div id="image-paper" class="figure_pagination">
                            <span id="current-page" class="num">1</span>
                            <span class="num off">/ <span id="total-page">2</span></span>
                        </div>
                    </div>
                ...
                <div id="product-content-container" class="section_store_details">
                    ...
                    <div class="store_details close3">
                        <p id="product-content-box" class="dsc">
                        </p>
                    </div>
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <strong class="text_value"> <span id="review-score-numerator">4.2</span> <em class="total">5.0</em> </strong>
                ...
                <div class="section_info_tab">
                    ...
                    <div class="detail_location hide">
                        <div class="box_store_info no_topline">
                            ...
                            <h3 id="way-to-come-product-description" class="store_name">엔에이치엔티켓링크(주)</h3>
                            <div class="store_info">
                                <div class="store_addr_wrap">
                                    <span class="fn fn-pin2"></span>
                                    <p id="way-to-come-place-street" class="store_addr store_addr_bold">서울특별시 종로구 종로33길 15 </p>
                                    <p class="store_addr">
                                        <span class="addr_old">지번</span>
                                        <span id="way-to-come-place-lot" class="addr_old_detail">서울특별시 종로구 연지동 270 </span>
                                    </p>
                                    <p id="way-to-come-place-name" class="store_addr addr_detail">{{placeName}}</p>
                                </div>
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="tel:02-548-0597" id="way-to-come-place-telephone" class="store_tel">02-548-0597</a></span> </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div>
                ...
                <div class="review_area">
                    <div class="thumb_area">
                        <a href="#" class="thumb" title="이미지 크게보기">
                            <img width="90" height="90" class="img_vertical_top" src="/{{this.commentImages.0.saveFileName}}" alt="리뷰이미지">
                        </a>
                ...
                {{/if}}
            <div class="info_area">
                <div class="review_info"> <span class="grade">{{floatScore score}}</span> <span class="name">{{reservationEmail}}</span> <span class="date">{{formatDate reservationDate}} 방문</span></div>
            </div>
        </div>
        </li>
        {{/each}}
