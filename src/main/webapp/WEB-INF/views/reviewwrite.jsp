...
<body>
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					...
					<h2><span id="reservation-title" class="title">${reservationInfo.displayInfo.productDescription}</span></h2>
				</div>
				<!-- 리뷰 별점 -->
				<div class="write_act">
				...
				<div class="review_contents write">
					...
					<label for="comment-text-area">
					    <textarea id="comment-text-area" cols="30" rows="10" class="review_textarea"></textarea>
					</label>
				</div>
				<!-- //리뷰 입력 -->
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<div class="guide_review">
							<span id="text-counter">0</span>/400
							<span>(최소5자이상)</span>
						</div>
					</div>
						...
						<div class="item_preview_thumbs">
							<ul class="lst_thumb">
								<li class="item" style="display: none;">
									<a href="#" class="anchor cancel_upload">
	...
	<span id="product-id" style="display:none">${reservationInfo.productId}</span>
